...
class Statistics:
    ...
    def initialize_logfile(self, LOG_DIR, model_name):
        ...
        f.write(
            "epoch, time, test_loss, train_loss, test_accuracy, train_acc, reconstruction_loss_train, reconstruction_loss_test, margin_loss_train, margin_loss_test\n")
        f.close()
    ...
    def save_stats(self, epoch):
        ...
        to_write = str(
            [epoch, time_spent, test_loss, train_loss, test_acc * 100, train_acc * 100, rec_loss, test_rec_loss,
             marg_loss, test_marg_loss])[1:-1] + "\n"
        f.write(to_write)
        f.close()
